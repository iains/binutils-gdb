...
const struct target_desc *tdesc_powerpc_altivec32_darwin;
static void
initialize_tdesc_powerpc_altivec32_darwin (void)
{
  ...
  feature = tdesc_create_feature (result.get (), "org.gnu.gdb.power.darwin");
  tdesc_create_reg (feature, "vrvalid", 324, 1, "vector", 32, "int");

  tdesc_powerpc_altivec32_darwin = result.release ();
}
