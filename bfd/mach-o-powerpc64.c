/* PowerPC64 Mach-O support for BFD.
   Copyright 2011-2023
...
#define bfd_mach_o_object_p bfd_mach_o_powerpc64_object_p
#define bfd_mach_o_core_p bfd_mach_o_powerpc64_core_p
#define bfd_mach_o_mkobject bfd_mach_o_powerpc64_mkobject

static bfd_cleanup
bfd_mach_o_powerpc64_object_p (bfd *abfd)
{
  return bfd_mach_o_header_p (abfd, 0, 0, BFD_MACH_O_CPU_TYPE_POWERPC_64);
}

static bfd_cleanup
bfd_mach_o_powerpc64_core_p (bfd *abfd)
{
  return bfd_mach_o_header_p (abfd, 0,
			      BFD_MACH_O_MH_CORE, BFD_MACH_O_CPU_TYPE_POWERPC_64);
}

static bool
bfd_mach_o_powerpc64_mkobject (bfd *abfd)
{
  ...
  mdata->header.cputype = BFD_MACH_O_CPU_TYPE_POWERPC_64;
...
/* The PAIR to h?16/lo1? relocs is used with the address set to half
   the offset (lower or upper for h* or l* respectively).  This means that
   it is likely to be out-of-range as far as BFD is concerned.	So we need
   to check it and allow the installation.  */

static bfd_reloc_status_type
bfd_mach_o_powerpc64_check_reloc (bfd *abfd ATTRIBUTE_UNUSED,
...
static bfd_reloc_status_type
bfd_mach_o_powerpc64_unhandled_reloc (bfd *abfd ATTRIBUTE_UNUSED,
				    arelent *reloc_entry,
				    asymbol *symbol ATTRIBUTE_UNUSED,
				    void *data ATTRIBUTE_UNUSED,
				    asection *input_section ATTRIBUTE_UNUSED,
...
static reloc_howto_type powerpc64_howto_table[]=
{
  /* 0 */
  HOWTO(BFD_RELOC_8, 0, 1, 8, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "8",
	false, 0xff, 0xff, false),
  HOWTO(BFD_RELOC_16, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_32, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "32",
	false, 0xffffffff, 0xffffffff, false),
  HOWTO(BFD_RELOC_64, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "64",
	false, MINUS_ONE, MINUS_ONE, false),
  /* 4 */
  HOWTO(BFD_RELOC_8_PCREL, 0, 1, 8, true, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "DISP_8",
	false, 0xff, 0xff, true),
  HOWTO(BFD_RELOC_16_PCREL, 0, 2, 16, true, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "DISP_16",
	false, 0xffff, 0xffff, true),
  HOWTO(BFD_RELOC_32_PCREL, 0, 4, 32, true, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "DISP_32",
	false, 0xffffffff, 0xffffffff, true),
  HOWTO(BFD_RELOC_64_PCREL, 0, 4, 32, true, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "DISP_64",
	false, MINUS_ONE, MINUS_ONE, true),
  /* 8 */
  HOWTO(BFD_RELOC_PPC_B26, 0, 4, 26, true, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "BRANCH24",
	false, 0x03fffffc, 0x03fffffc, true),
  HOWTO(BFD_RELOC_PPC_B16, 0, 2, 16, true, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "BRANCH14",
	false, 0xfffc, 0xfffc, true),
  HOWTO(BFD_RELOC_NONE, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_unhandled_reloc, "PB_LA_PTR",
	false, 0, 0, false),
  HOWTO(BFD_RELOC_NONE, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_unhandled_reloc, "JBSR",
	false, 0, 0, false),
  /* 12 */
  HOWTO(BFD_RELOC_MACH_O_PAIR, 0, 1, 8, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "PAIR_8",
	false, 0xff, 0xff, false),
  HOWTO(BFD_RELOC_MACH_O_PAIR, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "PAIR_16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PAIR, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "PAIR_32",
	false, 0xffffffff, 0xffffffff, false),
  HOWTO(BFD_RELOC_MACH_O_PAIR, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "PAIR_64",
	false, MINUS_ONE, MINUS_ONE, false),
  /* 16 */
  HOWTO(BFD_RELOC_MACH_O_SECTDIFF, 0, 1, 8, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "SECTDIFF_8",
	false, 0xff, 0xff, false),
  HOWTO(BFD_RELOC_MACH_O_SECTDIFF, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "SECTDIFF_16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_SECTDIFF, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "SECTDIFF_32",
	false, 0xffffffff, 0xffffffff, false),
  HOWTO(BFD_RELOC_MACH_O_SECTDIFF, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "SECTDIFF_64",
	false, MINUS_ONE, MINUS_ONE, false),
  /* 20 */
  HOWTO(BFD_RELOC_MACH_O_LOCAL_SECTDIFF, 0, 1, 8, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LOCDIFF_8",
	false, 0xff, 0xff, false),
  HOWTO(BFD_RELOC_MACH_O_LOCAL_SECTDIFF, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LOCDIFF_16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_LOCAL_SECTDIFF, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LOCDIFF_32",
	false, 0xffffffff, 0xffffffff, false),
  HOWTO(BFD_RELOC_MACH_O_LOCAL_SECTDIFF, 0, 4, 32, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LOCDIFF_64",
	false, MINUS_ONE, MINUS_ONE, false),
  /* 24 */
  HOWTO(BFD_RELOC_MACH_O_PPC_LO16, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LO16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PPC_HI16, 16, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "HI16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PPC_HA16, 16, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "HA16",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PPC_LO14, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LO14",
	false, 0xfffc, 0xfffc, false),
  /* 28 */
  HOWTO(BFD_RELOC_MACH_O_PPC_LO16_SECTDIFF, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LO16DIFF",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PPC_HI16_SECTDIFF, 16, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "HI16DIFF",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PPC_HA16_SECTDIFF, 16, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "HA16DIFF",
	false, 0xffff, 0xffff, false),
  HOWTO(BFD_RELOC_MACH_O_PPC_LO14_SECTDIFF, 0, 2, 16, false, 0,
	complain_overflow_bitfield,
	bfd_mach_o_powerpc64_check_reloc, "LO14DIFF",
	false, 0xfffc, 0xfffc, false),
};
#if 0
/* TODO: finish this.  */
...
static bool
bfd_mach_o_powerpc64_swap_reloc_in (arelent *res, bfd_mach_o_reloc_info *reloc)
{
  switch (reloc->r_type)
    {
	...
	res->howto =
		&powerpc64_howto_table[(reloc->r_pcrel << 2) | reloc->r_length];
	return true;
	break;

      case BFD_MACH_O_PPC_RELOC_PAIR:
	BFD_ASSERT (reloc->r_length < 3);
	res->howto = &powerpc64_howto_table[12 + reloc->r_length];
	return true;
	break;

      case BFD_MACH_O_PPC_RELOC_BR14:
	res->howto = &powerpc64_howto_table[9];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_BR24:
	res->howto = &powerpc64_howto_table[8];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_PB_LA_PTR:
	res->howto = &powerpc64_howto_table[10];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_JBSR:
	res->howto = &powerpc64_howto_table[11];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_SECTDIFF:
	BFD_ASSERT (reloc->r_scattered);
	BFD_ASSERT (reloc->r_length < 3);
	res->howto = &powerpc64_howto_table[16 + reloc->r_length];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_LOCAL_SECTDIFF:
	BFD_ASSERT (reloc->r_scattered);
	BFD_ASSERT (reloc->r_length < 3);
	res->howto = &powerpc64_howto_table[20 + reloc->r_length];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_LO16:
	res->howto = &powerpc64_howto_table[24];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_HI16:
	res->howto = &powerpc64_howto_table[25];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_HA16:
	res->howto = &powerpc64_howto_table[26];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_LO14:
	res->howto = &powerpc64_howto_table[27];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_LO16_SECTDIFF:
	res->howto = &powerpc64_howto_table[28];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_HI16_SECTDIFF:
	res->howto = &powerpc64_howto_table[29];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_HA16_SECTDIFF:
	res->howto = &powerpc64_howto_table[30];
	return true;
	break;
      case BFD_MACH_O_PPC_RELOC_LO14_SECTDIFF:
	res->howto = &powerpc64_howto_table[31];
	return true;
	break;
      default:
...
static bool
bfd_mach_o_powerpc64_canonicalize_one_reloc (bfd *       abfd,
...
static bool
bfd_mach_o_powerpc64_swap_reloc_out (arelent *rel, bfd_mach_o_reloc_info *rinfo)
{
  ...
  switch (rel->howto->type)
    ...
    default:
fprintf (stderr, "tried to swap out code %ld\n", (long int)rel->howto->type);
      return false;
    }
...
bfd_mach_o_powerpc64_bfd_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
					    bfd_reloc_code_real_type code)
{
  unsigned int i;

  for (i = 0; i < sizeof (powerpc64_howto_table) / sizeof (*powerpc64_howto_table); i++)
    if (code == powerpc64_howto_table[i].type)
      return &powerpc64_howto_table[i];
  return NULL;
}

/* TODO: Implement this.  */
static reloc_howto_type *
bfd_mach_o_powerpc64_bfd_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
...
/* TODO: Implement this.  */
static bool
bfd_mach_o_powerpc64_print_thread (bfd *abfd ATTRIBUTE_UNUSED,
				   ...
				   char *buf ATTRIBUTE_UNUSED)
{
  ...
  switch (thread->flavour)
	...
	fprintf (file, " TODO --- print the PPC64 thread state for %lu\n", thread->flavour);
	return true;
	break;
    ...
    default:
	fprintf (file, "UNEXPECTED PPC64 thread flavour %lu\n", thread->flavour);
      break;
    }
  return false;
}
...
const mach_o_segment_name_xlat mach_o_ppc64_segsec_names_xlat[] =
  {
...
#define bfd_mach_o_canonicalize_one_reloc  bfd_mach_o_powerpc64_canonicalize_one_reloc
#define bfd_mach_o_swap_reloc_out bfd_mach_o_powerpc64_swap_reloc_out
//#define bfd_mach_o_swap_reloc_in bfd_mach_o_powerpc64_swap_reloc_in
/* TODO: Implement this.  */
#define bfd_mach_o_print_thread bfd_mach_o_powerpc64_print_thread

#define bfd_mach_o_tgt_seg_table mach_o_ppc64_segsec_names_xlat
#define bfd_mach_o_section_type_valid_for_tgt NULL

#define bfd_mach_o_bfd_reloc_type_lookup bfd_mach_o_powerpc64_bfd_reloc_type_lookup
#define bfd_mach_o_bfd_reloc_name_lookup bfd_mach_o_powerpc64_bfd_reloc_name_lookup

#define TARGET_NAME		powerpc64_mach_o_vec
#define TARGET_STRING		"mach-o-powerpc64"
